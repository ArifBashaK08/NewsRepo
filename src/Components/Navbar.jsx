...
const Navbar = (props) => {
  ...
  return (
    <nav className="navbar navbar-expand-lg align-items-center position-sticky top-0 start-0" style={{ background: '#030637', zIndex: '100' }}>
      <div className="container-fluid">
        <Link className="navbar-brand fw-bold" to="/" style={{ backgroundImage: 'linear-gradient(90deg, rgba(0, 150, 136, 1) 0%, rgba(255, 193, 7, 1) 100%)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>{props.title}</Link>
